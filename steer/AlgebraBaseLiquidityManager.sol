...
// Algebra
import {IAlgebraFactory} from "@cryptoalgebrav1/core/contracts/interfaces/IAlgebraFactory.sol";
import {IAlgebraPool} from "@cryptoalgebrav1/core/contracts/interfaces/IAlgebraPool.sol";
import {TickMath} from "@cryptoalgebrav1/core/contracts/libraries/TickMath.sol";
import {FullMath} from "@cryptoalgebrav1/core/contracts/libraries/FullMath.sol";
import {IAlgebraMintCallback} from "@cryptoalgebrav1/core/contracts/interfaces/callback/IAlgebraMintCallback.sol";
import {IAlgebraSwapCallback} from "@cryptoalgebrav1/core/contracts/interfaces/callback/IAlgebraSwapCallback.sol";
import {LiquidityAmounts} from "@cryptoalgebrav1/periphery/contracts/libraries/LiquidityAmounts.sol";
import {PositionKey} from "@cryptoalgebrav1/periphery/contracts/libraries/PositionKey.sol";
...
abstract contract AlgebraBaseLiquidityManager is
  Initializable,
  ERC20Upgradeable,
  PausableUpgradeable,
  ...
  IAlgebraSwapCallback
{
  ...
  function initialize(
    ...
    // Naming system: STEER_Algebra_VAULT_$TotalVaultCount
    ...
    __ERC20_init(
      ...
      string(abi.encodePacked("STEERQV", vaultCount))
    );
